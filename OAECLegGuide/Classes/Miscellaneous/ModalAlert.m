...
+(NSUInteger) queryWith: (NSString *)question button1: (NSString *)button1 button2: (NSString *)button2{
    return [ModalAlert queryWith:nil title:question button1:button1 button2:button2]; 
}
...
+(NSUInteger) queryWith: (NSString *)question title:(NSString *)title button1: (NSString *)button1 button2: (NSString *)button2 {
	...
	UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:title message:question delegate:madelegate cancelButtonTitle:button1 otherButtonTitles:button2, nil];
	[alertView show];
